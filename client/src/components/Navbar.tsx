...
import weimer from '../assets/weimer_bearing.png';
        ...
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            <a
              ...
              href="#"
            >
              <img className="object-none" src={weimer} />
            </a>
            <button
          ...
          >
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              <li className="nav-item">
                ...
                >
                  <BsFillPlusCircleFill /><span className="ml-2">New</span>
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink to="/search" className="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75">
